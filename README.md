# Writing Load Plan JSON using External Id filed (Global_key__c) 

> In the document we explain how to write Load Plan JSON using External Id filed ```Global_key__c```  for using data migration from one org to another org using Salesforce Migration Tool (SMT)
